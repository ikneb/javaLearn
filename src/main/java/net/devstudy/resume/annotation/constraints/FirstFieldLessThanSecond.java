...
import net.devstudy.resume.validator.FirstFieldLessThanSecondConstaintValidator;


@Target({ TYPE, ANNOTATION_TYPE })
@Retention(RUNTIME)
@Constraint(validatedBy = {FirstFieldLessThanSecondConstaintValidator.class})
@Documented
