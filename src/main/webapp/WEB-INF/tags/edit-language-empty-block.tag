					...
					<div class="row">
						<div class="col-lg-2 col-sm-2 ">
							<div class="input-practic">
								<label for="begin-month">Тип</label> <select class="form-control" name="items[0].type">
						...
						<div class="col-lg-2 col-sm-2 ">
							<div class="input-practic">
								<label for="begin-month">Язык</label> <select class="form-control" name="items[0].name">
						...
						<div class="col-lg-6 col-sm-6">
							<div class="input-practic">
							<label for="begin-month">Уровень</label> <select class="form-control" name="items[0].level">
									<option ${language.level == 'BEGINER' ? ' selected="selected"' : ''} value="BEGINER">Beginner</option>
									<option ${language.level == 'ELEMENTARY' ? ' selected="selected"' : ''} value="ELEMENTARY">Elementary</option>
									<option ${language.level == 'PRE_INTERMEDIATE' ? ' selected="selected"' : ''} value="PRE_INTERMEDIATE">Pre-Intermed</option>
									<option ${language.level == 'INTERMEDIATE' ? ' selected="selected"' : ''} value="INTERMEDIATE">Intermed</option>
									<option ${language.level == 'UPPER_INTERMEDIATE' ? ' selected="selected"' : ''} value="UPPER_INTERMEDIATE">Upper-Intermed</option>
