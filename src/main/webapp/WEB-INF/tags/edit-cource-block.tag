		...
		<div class="row">
			<div class="col-lg-4 col-sm-4 ">
				<div class="input-practic">
					<label for="name-course">Название курса*</label> <input type="text" class="form-control" id="name-course" name="items[${index }].name" value="${course.name}"/>
				</div>
			</div>
			<div class="col-lg-4 col-sm-4">
				<div class="input-practic">
					<label for="school">Название учебного заведения*</label><input type="text" class="form-control" id="school" name="items[${index }].school" value="${course.school}"/>
				</div>
			</div>
