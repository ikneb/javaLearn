...
<div class="frame" id="ui-item-0">
	<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
	<br> <br>
	<div class="row">
		<div class="col-lg-6 col-sm-6">
			<div class="input-practic">
				<label for="usr">Должность</label> <input type="text" class="form-control" name="items[0].position">
			</div>
		...
		<div class="col-lg-6 col-sm-6">
			<div class="input-practic">
				<label for="usr">Компания или организация</label> <input type="text" class="form-control" name="items[0].company">
			</div>
			<div class="col-xs-offset-5 col-sm-offset-4 col-md-offset-2 col-xs-7 col-sm-8 col-md-10" style="padding-left: 0px;">
	...
	<div class="row">
		...
		<div class="col-lg-3 col-sm-3 ">
			<div class="input-practic">
				<label for="begin-month">Дата начала</label> <select class="form-control" id="begin-month" name="items[0].beginDateMonth">
		...
		<div class="col-lg-3 col-sm-3">
			<div class="input-practic">
				<label for="begin-year">.</label><select class="form-control" id="begin-year" name="items[0].beginDateYear">
			...
			<div class="col-xs-offset-5 col-sm-offset-4 col-md-offset-2 col-xs-7 col-sm-8 col-md-10" style="padding-left: 0px;">
				<form:errors path="items[0]" cssClass="alert alert-danger" element="div" />
			</div>
		...
		<div class="col-lg-3 col-sm-3">
			<div class="input-practic">
				<label for="finish-month">Дата завершения</label> <select class="form-control" id="finish-month" name="items[0].finishDateMonth">
		...
		<div class="col-lg-3 col-sm-3">
			<div class="input-practic">
				<label for="finish-year">.</label> <select class="form-control" id="finish-year" name="items[0].finishDateYear">
	...
	<div class="input-practic">
		...
		<textarea class="form-control" rows="5" id="comment" name="items[0].responsibilities"></textarea>
	</div>
	<div class="row skill-delim">
		<div class="col-xs-offset-5 col-sm-offset-4 col-md-offset-2 col-xs-7 col-sm-8 col-md-10" style="padding-left: 0px;">
	...
	<div class="row">
		<div class="col-lg-6 col-sm-6">
			<div class="input-practic">
				<label for="usr">Ссылка на демо</label> <input type="text" class="form-control" name="items[0].demo">
			</div>
			<div class="col-xs-offset-5 col-sm-offset-4 col-md-offset-2 col-xs-7 col-sm-8 col-md-10" style="padding-left: 0px;">
				<form:errors path="items[0].demo" cssClass="alert alert-danger" element="div" />
			</div>
		</div>
		<div class="col-lg-6 col-sm-6">
			<div class="input-practic">
				<label for="usr">Исходный код</label> <input type="text" class="form-control" name="items[0].src">
			</div>
			<div class="col-xs-offset-5 col-sm-offset-4 col-md-offset-2 col-xs-7 col-sm-8 col-md-10" style="padding-left: 0px;">
				<form:errors path="items[0].src" cssClass="alert alert-danger" element="div" />
			</div>
		</div>
	</div>
	<br>
