	...
	<div class="row">
		<div class="col-lg-6 col-sm-6">
			<div class="input-practic-bottom">
				<label for="usr">Вуз</label> <input type="text" class="form-control" id="usr" name="items[${index }].university" value="${education.university}">
			</div>
			<div class="row skill-delim">
			<div class="col-xs-offset-5 col-sm-offset-4 col-md-offset-2 col-xs-7 col-sm-8 col-md-10" style="padding-left: 0px;">
		...
		<div class="col-lg-6 col-sm-6">
			<div class="input-practic-bottom">
				<label for="usr">Факультет</label> <input type="text" class="form-control" id="usr" name="items[${index }].faculty" value="${education.faculty}">
			</div>
			<div class="row skill-delim">
			<div class="col-xs-offset-5 col-sm-offset-4 col-md-offset-2 col-xs-7 col-sm-8 col-md-10" style="padding-left: 0px;">
