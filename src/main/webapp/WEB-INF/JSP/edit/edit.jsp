...
<div class="container">
	<div id="content">
		<resume:edit-header selected="account"/>
		<div class="tab-content brd">
			<div class="panel panel-default">
				<form:form action="/edit/edit" method="post" enctype="multipart/form-data" commandName="accountForm" >
					...
					<div class="container">
						<div class="row">
							<div class="col-lg-7 text">
								<h4>Photo*</h4>
								<img src="${accountForm.account.largePhoto}"> <br> <br> <br>
								<div>
							...
							<div class="col-lg-4" style="padding-top: 80px;">
								<blockquote>
									1. Фотография может многое рассказать о кандидате: начиная от его эстетических качеств и заканчивая его отношением к поиску серьезной работы.
									<br>2. Фотография как на паспорт или в костюме необязательна, главное адекватность и ухоженный, аккуратный внешний вид.<br> 3.
									Размер фотографии должен быть не меньше чем 400х400. <br>4. Файл должен быть в формате jpg.
								</blockquote>
							</div>
						</div>
					</div>
