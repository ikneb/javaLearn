	...
	<div class="tab-content brd">
		...
		<form:form action="/edit/info" method="post" commandName="accountForm">
			<div class="input-practic">
				<textarea class="form-control" rows="5" id="" name="items[0].info">${info}</textarea>
				<div class="row skill-delim">
					<div class="col-xs-offset-5 col-sm-offset-4 col-md-offset-2 col-xs-7 col-sm-8 col-md-10" style="padding-left: 0px;">
						<form:errors path="items[0].info" cssClass="alert alert-danger" element="div" />
					</div>
				</div>
				<br>
				<blockquote>
					<p>
						...
						разработке програмного обеспечения, возможно опыт исследовательськой работы и НИИ и т.д.<br> Не стоит указывать ваши личностные качества,
						почти все кандидаты ответственны, комуникабельные и порядочные)))
					</p>
				</blockquote>
			</div>
