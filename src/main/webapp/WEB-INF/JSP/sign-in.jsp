					...
					<div class="panel-body">
						<form action="/sign-in-handler" method="post">
							...
							<div class="form-group" style="display: table; width: 100%;">
								...
								<a href="/restore" class="pull-right">Восстановить доступ</a>
							</div>
							<div class="form-group text-center">
								<a href="/fbLogin" class="btn btn-warning"><i class="fa fa-facebook" aria-hidden="true"></i> Войти через Facebook</a>
							</div>
						</form>
					</div>
				</div>
